...
const WORKS = [
  {
    id: "NX-001",
    title: "Neonstore Commerce",
    kind: "E-commerce",
    image: ecom,
    metric: "1.2M orders / yr",
  ...
  {
    id: "NX-002",
    title: "Pulse Analytics Grid",
    kind: "Dashboard",
    image: dash,
    metric: "40M events / day",
    body: "Realtime operational dashboard streaming millions of events into charts that stay under 100ms interaction.",
  ...
  },
  {
    ...
    image: crm,
    metric: "24k accounts",
    body: "Role-aware CRM with pipeline automation, activity graphs and audit-grade permissions across teams.",
    stack: ["React", "RLS", "Queues"],
  },
  {
    id: "NX-004",
    title: "Galaxy X Workspace",
    kind: "SaaS",
    image: saas,
    metric: "8k daily users",
    body: "Collaborative product workspace: live boards, presence, video rooms and AI-assisted planning.",
